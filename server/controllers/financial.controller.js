...
const addFinRecord = asyncHandler(async (req, res) => {
    ...
    res.status(201).json(new apiResponse(201, "Financial record added successfully", createdRecord));
  });
  ...
  const updateFinRecord = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(new apiResponse(200, "Financial record updated successfully", updatedRecord));
  });

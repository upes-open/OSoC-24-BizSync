...
const Contact = () => {
  return (
    <>
      <section className=" h-screen flex justify-center items-center font-poppins bg-hero-img bg-cover">
        <div className="max-w-6xl mx-auto   my-6 font-poppins text-[#011c2b]">
          <div className="flex flex-col text-center p-6">
            <h2 className="text-3xl text-white font-extrabold">Contact Us</h2>
            <p className="text-xs text-white mt-3 font-poppins">
              Have some big idea or brand to develop and need help?
            </p>
          </div>
          {/* left side */}
          <div className="grid lg:grid-cols-3 items-center gap-4 p-5 shadow-[0_2px_10px_-3px_rgba(6,81,237,1)] rounded-lg mt-8">
            <div className="bg-[#6F00FF] rounded-lg p-6 max-lg:text-center">
              ...
              <ul class="flex max-lg:justify-center mt-16 space-x-4">
                <li class="bg-white hover:bg-[#F7F7F7] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                  <a href="#">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18px"
            ...
            <div className="p-6 rounded-xl lg:col-span-2">
              <form>
                ...
                <button
                  type="button"
                  class="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-[#6F00FF] text-white hover:bg-[#6400FF]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16px"
